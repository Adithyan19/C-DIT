...
async function request(path, options = {}) {
    ...
    // Add a default generous timeout (5 minutes)
    ...
    try {
        ...
        if (err.name === 'AbortError') {
            throw new Error('Request timed out. Please wait a bit longer for the AI to respond next time.');
        }
        throw new Error('Network error or connection was closed.');
    }
    clearTimeout(id);
